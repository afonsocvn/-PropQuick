                ...
                <article className="max-w-3xl mx-auto prose prose-gray">
                    ...
                    <section className="space-y-6 text-gray-600 leading-relaxed">
                        ...
                        <div>
                            ...
                            <p>If you have any questions about this Privacy Policy, please reach out through <a href="mailto:sokkazt@gmail.com" className="text-primary hover:underline">sokkazt@gmail.com</a>.</p>
                        </div>
                    </section>
                </article>
            </main>
